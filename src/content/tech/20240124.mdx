---
title:
  'Now, Using Arc browser on Windows!'
description:
  'Although it still in open beta, let us try Arc browser on Windows. this is very pretty and has excellent features based on Chromium!'
isDraft: true
author: 'Dewdew'
language: 'en'
